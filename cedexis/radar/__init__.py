...
__sampler_micro_version__ = 1
__version_suffix__ = '-1'

def run_session(zone_id, customer_id, api_key='sandbox', secure=False, tracer=None, provider_id=None, strict=False):
    """Run a Radar session"""
    session_info = {
        'zone_id': zone_id,
